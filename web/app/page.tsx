        ...
        <>
            ...
            <div id='gif-parallax' className="flex justify-between items-center min-h-screen">
                <div className="mx-8">
                    ...
                    <a href="#benefits">
                        <svg className="m-auto text-primary drop-shadow-lg animate-bounce absolute bottom-4 left-0 right-0" xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="M10 14a2 2 0 1 1-4 0a2 2 0 0 1 4 0Zm1.78-8.841a.75.75 0 0 0-1.06 0l-1.97 1.97V.75a.75.75 0 0 0-1.5 0v6.379l-1.97-1.97a.75.75 0 0 0-1.06 1.06l3.25 3.25L8 10l.53-.53l3.25-3.25a.75.75 0 0 0 0-1.061Z" clip-rule="evenodd" /></svg>
                    </a>
                </div>

                <Image priority className="w-[800px] h-screen hidden sm:flow-root" src={'/images/mockup.png'} width={1200} height={1200} alt="NFC Orange animation" />
            </div>
            ...
            <div className="bg-slate-50 flex flex-wrap justify-center items-center pb-6">
                <div className="border-primary rounded-lg text-center border-2 max-w-[280px] h-[330px] bg-white drop-shadow-lg px-8 py-5 m-6">
                ...
                <div className="border-primary rounded-lg text-center border-2 max-w-[280px] h-[330px] bg-white drop-shadow-lg px-8 py-5 m-6">
                    <div className="flex justify-center text-red-400">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 48 48"><mask id="ipTPersonalCollection0"><g fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="4"><circle cx="24" cy="11" r="7" fill="#555" /><path d="M4 41c0-8.837 8.059-16 18-16" /><path fill="#555" d="M31.85 28C29.724 28 28 30.009 28 32.486c0 4.487 4.55 8.565 7 9.514c2.45-.949 7-5.027 7-9.514C42 30.01 40.276 28 38.15 28c-1.302 0-2.453.753-3.15 1.906C34.303 28.753 33.152 28 31.85 28Z" /></g></mask><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipTPersonalCollection0)" /></svg>
                    </div>
